...
# Endline
PATH_ZAM_HHE_HH_HOUSEINFO_RAW_240723 <- "2_data/zam/1_raw/Baseline and Endline Data/Endline Survey Dataset/Endline-census.xls"
...
PATH_ZAM_HHE_HH_DETAILED_HOUSEINFO_RAW_240723 <- "2_data/zam/1_raw/Baseline and Endline Data/Endline Survey Dataset/Endline-household.xls"
PATH_ZAM_HHE_HH_ITN_RAW_240723 <- "2_data/zam/1_raw/Baseline and Endline Data/Endline Survey Dataset/Endline-net.xls"
...
PATH_ZAM_HHE_HH_VISIT_RAW_240723 <- "2_data/zam/1_raw/Baseline and Endline Data/Endline Survey Dataset/Endline-visit.xls"
...
## Baseline
zam_hhb_hh_houseinfo_raw <- read_csv( here( PATH_ZAM_HHB_HH_HOUSEINFO_RAW_240723) )
zam_hhb_pr_raw <- read_csv( here( PATH_ZAM_HHB_PR_RAW_240723) )
zam_hhb_hh_detailed_houseinfo_raw <- read_csv( here( PATH_ZAM_HHB_HH_DETAILED_HOUSEINFO_RAW_240723) )
zam_hhb_hh_itn_raw <- read_csv( here( PATH_ZAM_HHB_HH_ITN_RAW_240723) )
zam_hhb_hh_test_raw <- read_excel( here( PATH_ZAM_HHB_HH_TEST_RAW_240723) )
zam_hhb_hh_visit_raw <- read_csv( here( PATH_ZAM_HHB_HH_VISIT_RAW_240723) )

## Endline
zam_hhe_hh_houseinfo_raw <- read_excel( here( PATH_ZAM_HHE_HH_HOUSEINFO_RAW_240723) )
zam_hhe_pr_raw <- read_csv( here( PATH_ZAM_HHE_PR_RAW_240723) )
