...
## clean ----
### DHIS2 ----
PATH_ZAM_DH_HF <- "2_data/zam/2_clean/ZAM_DH_HF.qs"
PATH_ZAM_DH_VL <- "2_data/zam/2_clean/ZAM_DH_VL.qs"
PATH_ZAM_DH_VL_POP <- "2_data/zam/2_clean/ZAM_DH_VL_POP.qs"

### Survey ----
PATH_ZAM_HH_HH <- "2_data/zam/2_clean/ZAM_HH_HH.qs"
PATH_ZAM_HH_CODEBOOK <- "2_data/zam/2_clean/ZAM_HH_CODEBOOK.qs"

#### Baseline ----
PATH_ZAM_HHB_HH_HOUSEINFO <- "2_data/zam/2_clean/ZAM_HHB_HH_HOUSEINFO.qs"
PATH_ZAM_HHB_PR <- "2_data/zam/2_clean/ZAM_HHB_PR.qs"
PATH_ZAM_HHB_HH_DETAILED_HOUSEINFO <- "2_data/zam/2_clean/ZAM_HHB_HH_DETAILED_HOUSEINFO.qs"
PATH_ZAM_HHB_HH_ITN <- "2_data/zam/2_clean/ZAM_HHB_HH_ITN.qs"
PATH_ZAM_HHB_HH_TEST <- "2_data/zam/2_clean/ZAM_HHB_HH_TEST.qs"
PATH_ZAM_HHB_HH_VISIT <- "2_data/zam/2_clean/ZAM_HHB_HH_VISIT.qs"

#### Endline ----
PATH_ZAM_HHE_HH_HOUSEINFO <- "2_data/zam/2_clean/ZAM_HHE_HH_HOUSEINFO.qs"
PATH_ZAM_HHE_PR <- "2_data/zam/2_clean/ZAM_HHE_PR.qs"
PATH_ZAM_HHE_HH_DETAILED_HOUSEINFO <- "2_data/zam/2_clean/ZAM_HHE_HH_DETAILED_HOUSEINFO.qs"
PATH_ZAM_HHE_HH_ITN <- "2_data/zam/2_clean/ZAM_HHE_HH_ITN.qs"
PATH_ZAM_HHE_HH_TEST <- "2_data/zam/2_clean/ZAM_HHE_HH_TEST.qs"
PATH_ZAM_HHE_HH_VISIT <- "2_data/zam/2_clean/ZAM_HHE_HH_VISIT.qs"
