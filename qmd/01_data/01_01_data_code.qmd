---
title: "Data Code for One Seven Project"
lightbox: true
format:
    html:
        toc: true
...
# Data Code for the One Seven Project
...
1. **Formula or Equation**:
    ...
    - Example:
     - **Incidence Rate Calculation**: 
        \[
        \text{Incidence Rate} = \left(\frac{\text{Number of New Cases}}{\text{Population at Risk}}\right) \times 1000
        \]
        Here, the incidence rate is calculated as the number of new cases per 1,000 population at risk.
